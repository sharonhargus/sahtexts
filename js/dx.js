/*
	Last update 13 March, 2019.  Added keystroke functionality.

	All of the change-me's are in the first section.

	Tools and scripts for Sharon Hargus' annotated websites.  
	Here BD/Belle Deacon files correspond to files with a single long audio, 
	and Chapman files refer to files with a folder of short audio clips.
*/
...
/* This should hae the format "//depts.washington.edu/<ACCOUNT NAME>/annsaver/index.cgi", 
	where account name is the text account for the website.  
	For example, the kwadacha website looks like
	"\\depts.washington.edu/kwatexts/annsaver/index.cgi" or "//depts.washington.edu/wittexts/annsaver/index.cgi"
	Make sure to include the quotes. 
*/
		this.f.action=window.location.protocol+<CHANGE-ME>;
		this.f.method="POST";
...
/* This should hae the format "//depts.washington.edu/<ACCOUNT NAME>/annsaver/index.cgi", where account name is the text account for the website.  For example, the kwadacha website looks like
	...
	Make sure to include the quotes. */
		this.f.action=window.location.protocol+"//depts.washington.edu/<CHANGE-ME>/annsaver/index.cgi";
		this.f.method="POST";
		var i = document.createElement("input");
		i.setAttribute("name","pathname");
		i.setAttribute("value",window.location.pathname);
...
*/
	src.setAttribute('src', <CHANGE-ME>+mediapath+<CHANGE-ME>);
...
*/
										window.location.hostname+<CHANGE-ME>+
